...
def evalrank(model_path, data_path=None, split='dev', fold5=False):
    ...
    # load model state
    model.load_state_dict(checkpoint['model'],'train')

    print('Loading dataset')

    data_loader = get_test_loader(split, opt.data_name_target, vocab,
                                  opt.batch_size_target, opt.workers, opt)
    #data_loader = get_test_loader(split, data_name, vocab,
...
if __name__ == '__main__':
    evalrank(model_path=" ",data_path=" ", split="test", fold5=False)
